    ...
    <Card className="border-violet-200 dark:border-violet-900/50 shadow-xs">
      ...
      <CardContent className="pt-6">
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            <label className="block text-xs font-semibold text-foreground">
              Descripción de la Vacante / Requisitos <span className="text-violet-600 dark:text-violet-400">*</span>
            </label>
            <textarea
              className="flex min-h-[140px] w-full rounded-2xl border border-violet-200 dark:border-violet-800/60 bg-violet-50/20  p-3 text-xs sm:text-sm text-foreground placeholder:text-muted-foreground shadow-2xs transition-colors focus-visible:border-violet-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/20 disabled:cursor-not-allowed disabled:opacity-50 resize-none"
